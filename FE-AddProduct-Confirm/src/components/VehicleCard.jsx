...
const VehicleCard = ({
    ...
    const [reviews, setReviews] = useState([
        { id: 1, user: 'Kamal Perera', rating: 5, comment: 'Great quality and excellent condition!', date: '2023-10-12' },
        { id: 2, user: 'Nimal Silva', rating: 4, comment: 'Good product. Satisfied with the purchase.', date: '2023-11-05' }
    ]);
                ...
                <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/60 backdrop-blur-sm animate-in fade-in duration-200">
                    ...
                    <div className="p-4 md:p-6 border-t border-gray-100 bg-gray-50/50">
                        ...
                        <div className="flex flex-col md:flex-row gap-8">
                            {/* Add Review Form */}
                            <div className="w-full md:w-1/3 p-4 bg-white rounded-xl shadow-sm border border-gray-100">
                                <h4 className="font-bold text-gray-800 mb-4 tracking-tight">Write a Review</h4>
                                ...
                                <div className="mb-4">
                                    ...
                                    <div className="flex gap-1">
                                        {[1, 2, 3, 4, 5].map((star) => (
                                            ...
                                            >
                                                <svg
                                                    className={`w-8 h-8 ${newRating >= star ? 'text-yellow-400' : 'text-gray-300'}`}
                                                    fill="currentColor"
                                                    viewBox="0 0 20 20"
                                                >
                                                    <path d="M9.049 2.927c.3-.921 1.603-.921 1.902 0l1.07 3.292a1 1 0 00.95.69h3.462c.969 0 1.371 1.24.588 1.81l-2.8 2.034a1 1 0 00-.364 1.118l1.07 3.292c.3.921-.755 1.688-1.54 1.118l-2.8-2.034a1 1 0 00-1.175 0l-2.8 2.034c-.784.57-1.838-.197-1.539-1.118l1.07-3.292a1 1 0 00-.364-1.118L2.98 8.72c-.783-.57-.38-1.81.588-1.81h3.461a1 1 0 00.951-.69l1.07-3.292z" />
                                ...
                                <div className="mb-4">
                                    ...
                                    <textarea
                                        ...
                                        className="w-full px-3 py-2 border border-gray-200 rounded-lg focus:ring-2 focus:ring-black focus:border-transparent outline-none text-sm transition-all resize-none h-24"
                                    ></textarea>
                                </div>

                                <button
                                    onClick={handleReviewSubmit}
                                    className="w-full bg-black hover:bg-gray-800 text-white font-bold py-2 px-4 rounded-lg transition-colors shadow-md text-sm"
                                >
                                    Submit Review
                                </button>
                            </div>
                            ...
                            <div className="w-full md:w-2/3">
                                {reviews.length === 0 ? (
                                    <div className="flex flex-col items-center justify-center p-8 bg-white rounded-xl border border-gray-100 border-dashed h-full">
                                        <p className="text-gray-500 font-medium text-center">No reviews yet. Be the first to review this product!</p>
                                    </div>
                                ) : (
                                    <div className="space-y-4 max-h-[400px] overflow-y-auto pr-2 custom-scrollbar">
                                        {reviews.map((review) => (
                                            <div key={review.id} className="bg-white p-4 rounded-xl shadow-sm border border-gray-100 transition-all hover:shadow-md">
                                                <div className="flex justify-between items-start mb-2">
                                                    <div>
